...
<div class="row">
	<div class="col-md-9">
		<div class="card">
			...
			<div class="card-body">
				<!--mengarahkan action ke halaman web itu sendiri-->
